...
const file_spooled_proto_rawDesc = "" +
	"\n" +
	"\rspooled.proto\x12\n" +
	"spooled.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xc2\x06\n" +
	"\x03Job\x12\x0e\n" +
	...
	"\x0fidempotency_key\x18\x12 \x01(\tR\x0eidempotencyKey\x12\x19\n" +
	"\blease_id\x18\x13 \x01(\tR\aleaseId\"\xa3\x03\n" +
	...
	"\x04jobs\x18\x01 \x03(\v2\x0f.spooled.v1.JobR\x04jobs\"\x91\x01\n" +
	...
	"\x05retry\x18\x04 \x01(\bR\x05retry\x12\x19\n" +
	"\blease_id\x18\x05 \x01(\tR\aleaseId\"z\n" +
	"\fFailResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x1d\n" +
	"\n" +
	"will_retry\x18\x02 \x01(\bR\twillRetry\x121\n" +
	"\x15next_retry_delay_secs\x18\x03 \x01(\x05R\x12nextRetryDelaySecs\"\x89\x01\n" +
	"\x11RenewLeaseRequest\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x1b\n" +
	"\tworker_id\x18\x02 \x01(\tR\bworkerId\x12%\n" +
	"\x0eextension_secs\x18\x03 \x01(\x05R\rextensionSecs\x12\x19\n" +
	"\blease_id\x18\x04 \x01(\tR\aleaseId\"p\n" +
